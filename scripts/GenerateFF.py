...
def Packmolinputfile(inpname,filetype,number,box,method='GaussianAntechamber'):
	'''
...
def GaussianAntechamber(molname,nmol,basisset='#HF/6-31G*',data='off'):
	'''
	molname : molecule name
	nmol : number of molecules packed into simulation box
